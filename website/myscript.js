...
{
custmmat=1;
document.getElementById("p1").innerHTML="<input type=text id='csp1' onchange='myp1change()' contenteditable='true' size='5'>"; 
document.getElementById("p2").innerHTML="<input type=text id='csp2' onchange='myp2change()'contenteditable='true' size='5'>";
document.getElementById("p3").innerHTML="<input type=text id='csp3' onchange='myp3change()' contenteditable='true' size='5'>";
document.getElementById("p4").innerHTML="<input type=text id='csp4' onchange='myp4change()' contenteditable='true' size='5'>";
document.getElementById("p5").innerHTML="<input type=text id='csp5' onchange='myp6change()' contenteditable='true' size='5'>";
document.getElementById("p6").innerHTML="<input type=text id='csp6' onchange='myp5change()' contenteditable='true' size='5'>";
document.getElementById("p7").innerHTML="<input type=text id='csp7' onchange='myp7change()' contenteditable='true' size='5'>";
document.getElementById("p8").innerHTML="<input type=text id='csp8' onchange='myp8change()' contenteditable='true' size='5'>";
document.getElementById("p9").innerHTML="<input type=text id='csp9' onchange='myp9change()' contenteditable='true' size='5'>";
document.getElementById("p10").innerHTML="<input type=text id='csp10' onchange='myp10change()' contenteditable='true' size='5'>";
unitchangefcn();
    if(start==0)
    {
...
if(custmmat==1)
{
    prop1=Number(document.getElementById("csp1").value);
    prop2=Number(document.getElementById("csp2").value);
    prop3=Number(document.getElementById("csp3").value);
    prop4=Number(document.getElementById("csp4").value);
    prop5=Number(document.getElementById("csp5").value);
    prop6=Number(document.getElementById("csp6").value);
    prop7=Number(document.getElementById("csp7").value);
    prop8=Number(document.getElementById("csp8").value);
    prop9=Number(document.getElementById("csp9").value); 
    prop10=Number(document.getElementById("csp10").value);
}
...
// morrow
 ...
 if(specimanvalue==1 && analysisvalue==1)
 {
	  ...
	  document.getElementById("msp1").innerHTML=Math.round(ylifpos); 
       ...
       {
           document.getElementById("msp1").innerHTML="N/a " 
       document.getElementById("esp1").innerHTML="N/a "
...
ctx.stroke();
 ...
 {
      document.getElementById("msp2").innerHTML="N/a "
             document.getElementById("esp2").innerHTML="N/a "
 }
       xlifepos=((lifpos-minlx)*(xpos1-xpos)/(lmaxx-lminx))+(xpos+(xpos1-xpos)*(minlx-lminx)/(lmaxx-lminx)) ;
       ylifepos=ypos1-(((ylifpos-minly)*(ypos1-ypos)/(lmaxy-lminy))+((ypos1-ypos)*(minly-lminy)/(lmaxy-lminy)) );
    ctx.beginPath();
...
ctx.stroke();
 ...
 {
     document.getElementById("msp3").innerHTML="N/a "
       document.getElementById("esp3").innerHTML="N/a "
 }
       xlifepos=((lifpos-minlx)*(xpos1-xpos)/(lmaxx-lminx))+(xpos+(xpos1-xpos)*(minlx-lminx)/(lmaxx-lminx)) ;
       ylifepos=ypos1-(((ylifpos-minly)*(ypos1-ypos)/(lmaxy-lminy))+((ypos1-ypos)*(minly-lminy)/(lmaxy-lminy)) );
    ctx.beginPath();
...
ctx.stroke();
 ...
 {
     document.getElementById("msp4").innerHTML="N/a "
       document.getElementById("esp4").innerHTML="N/a "
 }
       xlifepos=((lifpos-minlx)*(xpos1-xpos)/(lmaxx-lminx))+(xpos+(xpos1-xpos)*(minlx-lminx)/(lmaxx-lminx)) ;
       ylifepos=ypos1-(((ylifpos-minly)*(ypos1-ypos)/(lmaxy-lminy))+((ypos1-ypos)*(minly-lminy)/(lmaxy-lminy)) );
    ctx.beginPath();
...
var marconst=(stamp*stmean/(prop3*(prop2-stmean)))+eamp;
 ...
 {
      document.getElementById("esp11").innerHTML="N/a "
 document.getElementById("msp11").innerHTML="N/a "
 } 
       xlifepos=((lifpos-minlx)*(xpos1-xpos)/(lmaxx-lminx))+(xpos+(xpos1-xpos)*(minlx-lminx)/(lmaxx-lminx)) ;
...
document.getElementById("msp21").innerHTML=Math.round(flim*prop3*prop6/(prop6-stamp)) ;
 ...
 {
    document.getElementById("esp21").innerHTML="N/a "
document.getElementById("msp21").innerHTML="N/a "
 }
       xlifepos=((lifpos-minlx)*(xpos1-xpos)/(lmaxx-lminx))+(xpos+(xpos1-xpos)*(minlx-lminx)/(lmaxx-lminx)) ;
       ylifepos=ypos1-(((ypoos-minly)*(ypos1-ypos)/(lmaxy-lminy))+((ypos1-ypos)*(minly-lminy)/(lmaxy-lminy))) ;
...
document.getElementById("msp31").innerHTML=Math.round(flim*prop3*Math.sqrt((stmean/(2*stamp))+Math.sqrt(1+(stmean*stmean/(4*stamp*stamp))))) ; 
 ...
 {
      document.getElementById("esp31").innerHTML="N/a "
document.getElementById("msp31").innerHTML="N/a "
 }
       xlifepos=((lifpos-minlx)*(xpos1-xpos)/(lmaxx-lminx))+(xpos+(xpos1-xpos)*(minlx-lminx)/(lmaxx-lminx)) ;
       ylifepos=ypos1-(((ypoos-minly)*(ypos1-ypos)/(lmaxy-lminy))+((ypos1-ypos)*(minly-lminy)/(lmaxy-lminy))) ;
...
if(langv==4)
{
window.open('Japanese.pdf','_blank');
}
if(langv==7)
{
...
function myp1change()
{
abc=Number(document.getElementById("csp1").value);
if(abc <=0 | abc>10000)
{
    alert("value must be in between 0 and 10000");
    document.getElementById("csp1").value="";
    document.getElementById("csp1").focus();
}
}
...
{
abc=Number(document.getElementById("csp1").value);
bcd=Number(document.getElementById("csp2").value);
if(abc=="")
{
    alert("you must enter a number in \u03C3o");
    document.getElementById("csp1").focus();
    
}
else
{
  if(bcd < abc | bcd > 10000)
  {
     alert("you must enter a number in between  \u03C3o and 10000");
         document.getElementById("csp2").value="";
    document.getElementById("csp2").focus(); 
  }  
}
...
function myp3change()
{
    abc=Number(document.getElementById("csp3").value);
 if(abc <=0 | abc>220000)
{
    alert("value must be in between 0 and 220000");
    document.getElementById("csp3").value="";
    document.getElementById("csp3").focus();
}   
}
function myp4change()
{
abc=Number(document.getElementById("csp2").value);
bcd=Number(document.getElementById("csp4").value);
if(abc=="")
{
    alert("you must enter a number in \u03C3u");
    document.getElementById("csp2").focus();
...
else
{
  if(bcd <abc | bcd>10000)
  {
     alert("you must enter a number in between  \u03C3u and 10000");
    document.getElementById("csp4").focus(); 
  }  
}
...
{
abc=Number(document.getElementById("csp1").value);
bcd=Number(document.getElementById("csp6").value);
if(abc=="")
{
    alert("you must enter a number in \u03C3o");
    document.getElementById("csp1").focus();
...
else
{
  ...
  {
     alert("you must enter a number in between  \u03C3o and 10000");
    document.getElementById("csp6").focus(); 
  }  
}
...
function myp6change()
{
 abc=Number(document.getElementById("csp5").value);
 if(abc <=0 | abc>1)
{
    alert("value must be in between 0 and 1 ");
    document.getElementById("csp5").value="";
    document.getElementById("csp5").focus();
}   
}
function myp7change()
{
     abc=Number(document.getElementById("csp7").value);
 if(abc <=-0.5 | abc >=0)
{
    alert("value must be in between -0.5 and 0");
    document.getElementById("csp7").value="";
    document.getElementById("csp7").focus();
}   

}
function myp8change()
{
 abc=Number(document.getElementById("csp8").value);
 if(abc <=0 | abc>10)
{
    alert("value must be in between 0 and 10");
    document.getElementById("csp8").value="";
    document.getElementById("csp8").focus();
}   
}
function myp9change()
{
 abc=Number(document.getElementById("csp9").value);
 if(abc <=-1 | abc>0)
{
    alert("value must be in between -1 and 0");
    document.getElementById("csp9").value="";
    document.getElementById("csp9").focus();
}   
}
function myp10change()
{
 abc=Number(document.getElementById("csp10").value);
 if(abc <=0 | abc>1)
{
    alert("value must be in between 0 and 1");
    document.getElementById("csp10").value="";
    document.getElementById("csp10").focus();
}   
}