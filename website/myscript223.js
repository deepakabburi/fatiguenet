...
{
custmmat=1;
document.getElementById("p1").innerHTML="<input type=text id='csp1' contenteditable='true' size='5'>"; 
document.getElementById("p2").innerHTML="<input type=text id='csp2' contenteditable='true' size='5'>";
document.getElementById("p3").innerHTML="<input type=text id='csp3' contenteditable='true' size='5'>";
document.getElementById("p4").innerHTML="<input type=text id='csp4' contenteditable='true' size='5'>";
document.getElementById("p5").innerHTML="<input type=text id='csp5' contenteditable='true' size='5'>";
document.getElementById("p6").innerHTML="<input type=text id='csp6' contenteditable='true' size='5'>";
document.getElementById("p7").innerHTML="<input type=text id='csp7' contenteditable='true' size='5'>";
document.getElementById("p8").innerHTML="<input type=text id='csp8' contenteditable='true' size='5'>";
document.getElementById("p9").innerHTML="<input type=text id='csp9' contenteditable='true' size='5'>";
document.getElementById("p10").innerHTML="<input type=text id='csp10' contenteditable='true' size='5'>";
unitchangefcn();
    if(start==0)
    {
...
{
prop1=document.getElementById("csp1").value;
    prop2=document.getElementById("csp2").value;
    prop3=document.getElementById("csp3").value;
    prop4=document.getElementById("csp4").value;
    prop5=document.getElementById("csp5").value;
    prop6=document.getElementById("csp6").value;
    prop7=document.getElementById("csp7").value;
    prop8=document.getElementById("csp8").value;
    prop9=document.getElementById("csp9").value; 
prop10=document.getElementById("csp10").value;
}
